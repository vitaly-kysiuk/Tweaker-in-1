...
namespace Tweaker_in_1.FunctionalForForms
{
    internal class TrustedInstaller
    {
        ...
        public static void CreateProcessAsTrustedInstaller(int parentProcessId, string binaryPath)
        {
            ...
            CreateProcess(null, binaryPath, ref ps, ref ts, true, EXTENDED_STARTUPINFO_PRESENT | CREATE_NEW_CONSOLE, IntPtr.Zero, null, ref siEx, out pInfo);
        ...
        public static void Run(string commandLine)
        {
            ...
            int pid = StartTrustedInstallerService();
            CreateProcessAsTrustedInstaller(pid, commandLine);
        }
    }
}
